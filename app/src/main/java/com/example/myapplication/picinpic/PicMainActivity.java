...
package com.example.myapplication.picinpic;
...
public class PicMainActivity extends AppCompatActivity {
    ...
    void updatePictureInPictureActions(
        ...
        final PendingIntent intent =
                PendingIntent.getBroadcast(
                        ...
                        0);
        final Icon icon = Icon.createWithResource(PicMainActivity.this, iconId);
        actions.add(new RemoteAction(icon, title, title, intent));

        // Another action item. This is a fixed action.
        actions.add(
                new RemoteAction(
                        Icon.createWithResource(PicMainActivity.this, R.drawable.ic_info_24dp),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pic_play_activity);
